  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      >
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm ">
              Unrivale Gym. Unparalleled Training Fitness Classes. World Class
              Studios to get the Body Shape That your Dream of... Get Your Dream
              Body Now
            </p>
          </motion.div>
          <motion.div
        ...
        <div className="flex basis-3/5 justify-center z-10 md:ml-40 md:mt-16 md:justify-end">
